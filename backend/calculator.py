...
def calculate_tax(trades, user_slab=0.0):
    ...
    for t in trades:
        ...
        if gain > 0:
            if asset == 'equity':
                ...
                tax = gain * (DEBT_MF_OLD_LTCG_RATE if gain_type == 'LTCG' else user_slab)
        ...
        trade_results.append({
            ...
            "sell_price": t['sell_price'], "asset_type": asset,
    ...
    if total_equity_ltcg > 0:
        ...
        summary['ltcg_tax'] = taxable * EQUITY_LTCG_RATE

    summary['total_tax_before_cess'] = (
        summary['stcg_tax'] + summary['ltcg_tax'] + summary['crypto_tax'] + summary['debt_mf_tax']
    )
