    ...
    function createTradeCard(data = {}) {
        ...
        card.innerHTML = `
            ...
            <div class="grid">
                ...
                <div class="form-group"><label>Stock / Asset Name</label><input type="text" class="stock-name" value="${data.stock_name||''}" required></div>
                ...
                <div class="form-group"><label>Buy Price (INR)</label><input type="number" step="0.01" class="buy-price" value="${data.buy_price||''}" required></div>
                ...
                <div class="form-group"><label>Sell Price (INR)</label><input type="number" step="0.01" class="sell-price" value="${data.sell_price||''}" required></div>
        ...
        card.querySelectorAll('input').forEach(inp => {
            inp.addEventListener('input', () => {
                ...
                if(inp.classList.contains('buy-price') || inp.classList.contains('sell-price')) {
